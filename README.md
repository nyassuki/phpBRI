...
# Getting Started with BRIAPI_collection copy

## Introduction

Postman collection for BRIAPI
...
![Building SDK - Step 1](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=installDependencies)
...
The following section explains how to use the BRIAPICollectionCopyLib library in a new project.

### 1. Open Project in an IDE

Open an IDE for PHP like PhpStorm. The basic workflow presented here is also applicable if you prefer using a different editor or IDE.

![Open project in PHPStorm - Step 1](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=openIDE)

Click on `Open` in PhpStorm to browse to your generated SDK directory and then click `OK`.

![Open project in PHPStorm - Step 2](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=openProject0)

### 2. Add a new Test Project

Create a new directory by right clicking on the solution name as shown below:

![Add a new project in PHPStorm - Step 1](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=createDirectory)

Name the directory as "test".

![Add a new project in PHPStorm - Step 2](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=nameDirectory)

Add a PHP file to this project.

![Add a new project in PHPStorm - Step 3](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=createFile)

Name it "testSDK".

![Add a new project in PHPStorm - Step 4](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=nameFile)
...
![Add a new project in PHPStorm - Step 5](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=projectFiles)
...
![Run Test Project - Step 1](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=openSettings)

Select `PHP` from within `Languages & Frameworks`.

![Run Test Project - Step 2](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=setInterpreter0)

Browse for Interpreters near the `Interpreter` option and choose your interpreter.

![Run Test Project - Step 3](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=setInterpreter1)

Once the interpreter is selected, click `OK`.

![Run Test Project - Step 4](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=setInterpreter2)

To run your project, right click on your PHP file inside your Test project and click on `Run`.

![Run Test Project - Step 5](https://apidocs.io/illustration/php?workspaceFolder=BRIAPICollectionCopy&step=runProject)
...
```php
$client = BRIAPICollectionCopyLib\BRIAPICollectionCopyClientBuilder::init()
